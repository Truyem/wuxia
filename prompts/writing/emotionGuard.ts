...
export const WritingEmotionGuard: PromptStructure = {
    ...
    title: 'Thực tế Cảm xúc và Bảo vệ Cảm xúc Cực đoan',
    content: `<Emotion Guard>
...
- CẤM: Nhân vật nảy sinh sự sùng bái vô căn cứ, lòng trung thành kiểu hiến tế, phụ thuộc nhân cách vào Người chơi (\`Player\`) khi thiếu nền tảng tương tác đầy đủ.
