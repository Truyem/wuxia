...
3. **Ranh giới tự sự**
   ...
   - Các sự kiện lớn trong thế giới cần được truy xuất và hiện thực hóa thông qua \`gameState.Thế giới\` và \`gameState.Cốt truyện\`.

4. **Thời gian và Địa điểm**
   - Sự tiến triển của thời gian và thay đổi địa điểm cần đồng bộ với \`gameState.Môi trường\`.
