...
const InAppConfirmModal: React.FC<Props> = ({
    ...
    return (
        <div className="fixed inset-0 z-[400] bg-black/70 backdrop-blur-md flex items-center justify-center p-4">
            <div className="w-full max-w-md rounded-none border border-wuxia-gold/30 bg-modal-gradient shadow-[0_0_60px_rgba(0,0,0,0.85)] p-5">
                <div className="text-lg font-serif font-bold text-wuxia-gold mb-3">{title}</div>
                <div className="max-h-[60vh] overflow-y-auto pr-1 text-sm text-paper-white/80 whitespace-pre-line break-words leading-relaxed">
                    {message}
                </div>
