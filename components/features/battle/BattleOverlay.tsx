...
const BattleOverlay: React.FC<Props> = ({ state, onAction, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black/90 backdrop-blur-md z-[300] flex flex-col items-center justify-center p-4 md:p-8 animate-in fade-in zoom-in-95 duration-300">
