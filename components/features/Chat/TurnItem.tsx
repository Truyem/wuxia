            ...
            <div className="flex items-center justify-center gap-4 mb-6 relative z-10">
                ...
                <div className="flex items-center gap-2">
                    ...
                    {isLatest && onReroll && (
                        <button
                            onClick={onReroll}
                            className="p-1.5 rounded-full border border-gray-700 text-gray-500 hover:text-emerald-400 hover:border-emerald-400 hover:scale-110 active:scale-95 hover:bg-emerald-400/10 hover:shadow-[0_0_15px_rgba(52,211,153,0.3)] transition-all cursor-pointer"
